 ...
 */
public class UnitTypeCdField extends MLCSLookupField<Integer> {

    public UnitTypeCdField(Field field, Layout model) {
        super(field, MdmsLocaleId.UNIT_TYPE, model, MdmsConstants.UNIT_TYPE);

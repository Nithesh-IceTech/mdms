 ...
 */
public class SupplyTypeCdField extends MLCSLookupField<Integer> {

    public SupplyTypeCdField(Field field, Layout model) {
        super(field, MdmsLocaleId.SUPPLY_TYPE, model, MdmsConstants.SUPPLY_TYPE);
    }

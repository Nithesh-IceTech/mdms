 ...
 */
public class ServiceGroupCdField extends MLCSLookupField<String> {

    public ServiceGroupCdField(Field field, Layout model) {
        super(field, MdmsLocaleId.SERVICE_GROUP, model, MdmsConstants.SERVICE_GROUP);

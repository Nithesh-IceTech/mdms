...
//
//public class MeterStateChart extends AbstractChart {
//
//    @Inject
//    @TextFile("charts/meter_detail.sql")
//    private String sql;
//
...
//    }
//
//    public static MeterStateChart getNewInstance(BeanManager beanManager, PointClickEvent event, String title, String tableName) {
//        String type = ((DataSeries) event.getSeries()).get(event.getPointIndex()).getName();
//        MeterStateChart surveyPerStateChart = getBean(beanManager, MeterStateChart.class);
...
//                applyFilter(entityType.viewClass, entityType.tableName, type, entityType.stateLookup));
//        return null;
//    }
//
